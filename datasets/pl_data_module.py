...
datapath_configs = dict(
    coco=dict(
        training_config=dict(
            train_img_data_dir='data/coco/images/train2017', 
            val_img_data_dir='data/coco/images/val2017', 
    ...
    coco_original=dict(
        training_config=dict(
            train_img_data_dir='data/coco/images/train2017', 
            val_img_data_dir='data/coco/images/train2017', 
            test_img_data_dir='data/coco/test2017',
            dataset_type='coco',
            train_ann_path="data/coco/annotations/instances_train2017.json",
            val_ann_path="data/coco/annotations/instances_val2017.json",
    ...
    objects365lmdb=dict(
        training_config=dict(
            train_img_data_dir='', 
            val_img_data_dir='data/coco/images/val2017', 
            test_img_data_dir='data/coco/images/val2017',
